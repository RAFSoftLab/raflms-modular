...
public class StudentInfo {
    ...
    public StudentInfo(Integer indexNumber, String startYear, String studyProgramShort) {
        this.indexNumber = indexNumber;
        this.startYear = startYear;
        this.studyProgramShort = studyProgramShort;
    }

    public StudentInfo(String firstName, String lastName, Integer indexNumber, String startYear, String studyProgramShort) {
